...
import {  CouponDto, CouponServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class DetailsComponent  extends AppComponentBase implements OnInit {
  ...
  constructor(injector: Injector,
    private _formBuilder: FormBuilder, private _companyService: CouponServiceProxy,
