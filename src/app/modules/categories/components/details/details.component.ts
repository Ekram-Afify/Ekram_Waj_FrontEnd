...
import {  AdminCategoryDto, AdminCategoryServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class DetailsComponent extends AppComponentBase implements OnInit {
  ...
  category: AdminCategoryDto = new AdminCategoryDto();
  centers;
  isLinear = false;
  items: MenuItem[];
  ...
  constructor(injector: Injector,
    private _formBuilder: FormBuilder, private _categoryService: AdminCategoryServiceProxy,
