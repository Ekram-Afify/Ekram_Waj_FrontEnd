...
import {  CategoryDto, CompanyServiceProxy, CreateCategoryDto, UpdateCompanyDto } from '@shared/service-proxies/service-proxies';
...
export class UpdateCompanyComponent  extends AppComponentBase implements OnInit {
  ...
  constructor(injector: Injector,
    private _formBuilder: FormBuilder, private _companyService: CompanyServiceProxy,
  ...
  ngOnInit() {
    this.items = [
      { label: this.l('Companies') },
      { label: this.l('UpdateCompany') }
    ];
...
debugger;
    ...
    this.company.name = this.firstFormGroup.value.name;
    this.company.nameAr = this.firstFormGroup.value.nameAr;
    this.company.description = this.firstFormGroup.value.description;
    this.company.descriptionAr = this.firstFormGroup.value.descriptionAr;
    this.save();
    }
  }
  ...
  cancel(){
    this._router.navigate(['/app/companies']);
  }
