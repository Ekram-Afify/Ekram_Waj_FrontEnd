...
import {  CompanyDto, CompanyServiceProxy, CreateCompanyDto } from '@shared/service-proxies/service-proxies';
...
export class CreateCompanyComponent extends AppComponentBase implements OnInit {
  ...
  constructor(injector: Injector,
    private _formBuilder: FormBuilder, private _companyService: CompanyServiceProxy,private _router: Router) {
    super(injector);
  }
