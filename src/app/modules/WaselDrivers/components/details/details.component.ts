...
import {  CompanyDto, CompanyServiceProxy, AdminVechileDto, AdminVechileServiceProxy, AdminWaselDriverDto, AdminWaselDriverServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class DetailsComponent extends AppComponentBase implements OnInit {
  ...
  company: AdminWaselDriverDto = new AdminWaselDriverDto();
  centers;
  isLinear = false;
  items: MenuItem[];
  ...
  constructor(injector: Injector,
    private _formBuilder: FormBuilder, private _companyService: AdminWaselDriverServiceProxy,
  ...
  ngOnInit() {
    this.items = [
      { label: this.l('WaselDrivers') },
      { label: this.l('WaselDriverDetails') }
    ];
