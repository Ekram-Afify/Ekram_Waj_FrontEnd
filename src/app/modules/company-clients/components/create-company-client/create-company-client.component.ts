...
import { CompanyDto, AdminCategoryServiceProxy, AdminCreateCompanyClientDto, TokenAuthServiceProxy, CompanyServiceProxy, CompanyDtoPagedResultDto } from '@shared/service-proxies/service-proxies';
import { finalize } from 'rxjs/operators';
import { SaveEditableRow } from 'primeng/table/table';
import { message } from '@shared/Message/message';
import { Router } from '@angular/router';
@Component({
  selector: 'app-create-company-client',
  templateUrl: './create-company-client.component.html',
  styleUrls: ['./create-company-client.component.scss']
})
export class CreateCompanyClientComponent extends AppComponentBase implements OnInit {
  ...
  companyClient: AdminCreateCompanyClientDto = new AdminCreateCompanyClientDto();
  centers;
  isLinear = false;
  items: MenuItem[];
  ...
  constructor(injector: Injector,
    private _formBuilder: FormBuilder, private _tokenAuthtService: TokenAuthServiceProxy,
    private _router: Router, private _categoryService: CompanyServiceProxy) {
    super(injector);
  }
  ...
  save() {
    ...
    this._tokenAuthtService
      .createCompanyClient(this.companyClient)
      .pipe(
        finalize(() => {
        })
      )
