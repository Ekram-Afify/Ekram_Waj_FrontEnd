...
import {  AdminCompanyClientDto, AdminCompanyClientServiceProxy, CompanyServiceProxy, CompanyDtoPagedResultDto } from '@shared/service-proxies/service-proxies';
...
export class DetailsComponent extends AppComponentBase implements OnInit {
  ...
  companyClient: AdminCompanyClientDto = new AdminCompanyClientDto();
  centers;
  isLinear = false;
  items: MenuItem[];
  ...
  constructor(injector: Injector,
    ...
    private route: ActivatedRoute,private _router: Router,private _categoryService: CompanyServiceProxy) {
    super(injector);
  }
  ...
  initCatss() {
    this._categoryService
      ...
      .subscribe((result : CompanyDtoPagedResultDto) => {
        ...
        var t =this.categories.find(c => c.value == this.companyClient.companyId);
        this.categories=[];
