...
export class ResetPasswordComponent extends AppComponentBase implements OnInit {
    ...
    init() {
        // this._accountService.verifyPasswordResetCode(this.userId, this.passwordResetCode).subscribe((result) => {
        //     if (!result) {
    ...
    resetPassword() {
        ...
        // this._accountService.resetPassword(this.userId, this.passwordResetCode, this.newPasswordValue)
        //     .subscribe((result) => {
